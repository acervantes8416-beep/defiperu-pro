...
const demoAssets: Record<RiskProfileType, AssetPnL[]> = {
  ...
  agresivo: [
    ...
    { symbol: "SOL/USDT", entry_price: 178.50, current_price: 185.40, quantity: 10.78, value_usd: 1998.61, pnl_usd: 74.38, pnl_pct: 3.87, change_24h: -0.8 },
    { symbol: "AVAX/USDT", entry_price: 36.20, current_price: 38.70, quantity: 20.67, value_usd: 799.93, pnl_usd: 51.68, pnl_pct: 6.91, change_24h: 3.2 },
    { symbol: "LINK/USDT", entry_price: 17.80, current_price: 18.50, quantity: 37.84, value_usd: 700.04, pnl_usd: 26.49, pnl_pct: 3.93, change_24h: 1.8 },
    { symbol: "DOT/USDT", entry_price: 7.20, current_price: 7.80, quantity: 64.10, value_usd: 499.98, pnl_usd: 38.46, pnl_pct: 8.33, change_24h: -1.5 },
